    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link" href="#services">GRAFIK</a></li>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <div class="masthead-heading text-uppercase">Berita Terkini Kota Deli Serdang</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="#contact">Masukkan Anda</a>
            </div>
        </header>
        <!-- Services-->
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Melihat banyaknya tanggapan positif dan negatif dari keseluruhan berita</h3>
                </div>
                <div class="card">
